...
/**
 * <p>1678. 设计 Goal 解析器
 * <p>请你设计一个可以解释字符串 command 的 Goal 解析器 。command 由 "G"、"()" 和/或 "(al)" 按某种顺序组成。Goal 解析器会将 "G" 解释为字符串 "G"、"()" 解释为字符串 "o"
 ...
 */
public class Ch1678GoalParserInterpretation {
