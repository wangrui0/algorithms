...
/**
 * 14  * fileName：IssueCert 15  * 16  * @author ：zyz 17  * Date    ：2020/1/15 12:46 18  * ------------------------- 19 *
 * 功能和描述：颁发证书 20
 **/
public class IssueCert {
   ...
   * 私钥证书-用于签名
   */
  public static final String ISSUE_PFX_FILE = "D:\\mykey.pfx";
  /**
   * 公钥证书-用于验签
   */
  public static final String ISSUE_CRT_FILE = "D:\\mykey.cer";
   ...
   * 定义crt根证书文件
   */
  public static final String ROOT_ISSUE_CRT_FILE = "D:\\mykey.cer";
  ...
  public static void createIssueCert(X500Name rootX500name, X500Name subjectX500Name) {
    try {
      ...
      IssueCertUtils
          .createKeyStore(ISSUE_ALIAS, certAndKeyGen.getPrivateKey(), ISSUE_PASSWORD.toCharArray(), x509Certificates,
              ISSUE_PFX_FILE);
